...
得知自己之所以能活著，是以摯友們的生命為代價，且自己完全被蒙在鼓裡，巨大的崩潰與罪惡感瞬間擊碎了小明，他無法承受這樣的真相，於是選擇跳樓自盡。`,
  ...
  plotQuiz: {
    correct: "小明是山難唯一生還者。當年斷糧，同伴騙他說各自切下手臂餵他；某晚廣播卻報導那些死者遺體「完整無缺」，他才驚覺自己吃下的是被犧牲同伴的血肉，崩潰而跳樓。",
    wrong: [
      "廣播播出當年山難的兇手落網，原來同伴是被謀殺的；小明無法承受真相而輕生。",
      "小明從廣播聽見通緝自己的消息，想起山難時是他害死同伴才獨活，畏罪跳樓。",
      "廣播報導一場空難，罹難名單上有小明失散多年的戀人，他悲痛欲絕跳樓。"
    ]
  }
});
