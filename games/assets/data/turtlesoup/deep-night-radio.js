...
得知自己之所以能活著，是以摯友們的生命為代價，且自己完全被蒙在鼓裡，巨大的崩潰與罪惡感瞬間擊碎了小明，他無法承受這樣的真相，於是選擇跳樓自盡。`,
  ...
  guessOptions: [
    { text: "當年朋友們騙他吃下的其實是至親好友的血肉，而不是約定好的手臂；遺體完整無缺代表朋友們根本沒有像約定的那樣切下手臂，他這才驚覺自己是靠著吃下同伴的肉活下來的。", correct: true },
    { text: "他其實一直都知道自己吃的是人肉，只是當年選擇自我催眠、說服自己那是海龜肉；這次聽到新聞報導遺體完整無缺，讓他確認自己長期以來的謊言與逃避終於藏不住了，是對自己多年欺騙自己的崩潰。" },
    { text: "廣播提到的死者遺體完整，讓他誤以為那些朋友其實沒有真的死於山難，而是被人蓄意謀殺後棄屍，他因為發現朋友可能死於他殺而非意外，加上長年的愧疚感一次爆發，才選擇跳樓。" }
  ]
});
